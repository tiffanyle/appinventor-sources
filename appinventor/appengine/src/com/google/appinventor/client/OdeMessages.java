...
public interface OdeMessages extends Messages {
    ...
    @DefaultMessage("XGyroProperties") 
    @Description("")
    String XGyroProperties();
   
    @DefaultMessage("YGyroProperties") 
    @Description("")
    String YGyroProperties();
    
    @DefaultMessage("ZGyroProperties") 
    @Description("")
    String ZGyroProperties();
    
    @DefaultMessage("XMagnetometerProperties") 
    @Description("")
    String XMagnetometerProperties();
    
    @DefaultMessage("YMagnetometerProperties") 
    @Description("")
    String YMagnetometerProperties();
    
    @DefaultMessage("ZMagnetometerProperties") 
    @Description("")
    String ZMagnetometerProperties();
    
    @DefaultMessage("HumidityProperties") 
    @Description("")
    String HumidityProperties();
    
    @DefaultMessage("PressureProperties") 
    @Description("")
    String PressureProperties();
    
    @DefaultMessage("TemperatureProperties") 
    @Description("")
    String TemperatureProperties();

    @DefaultMessage("UseFahrenheitProperties") 
    @Description("")
    String UseFahrenheitProperties();
    
    @DefaultMessage("AccelProfileUpdatedEvents") 
    @Description("")
    String AccelProfileUpdatedEvents();
    
    @DefaultMessage("SensorsUpdatedEvents") 
    @Description("")
    String SensorsUpdatedEvents();
    
    @DefaultMessage("EnvSensorsUpdatedEvents") 
    @Description("")
    String EnvSensorsUpdatedEvents();
}
